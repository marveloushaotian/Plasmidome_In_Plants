process PHYLOGENY_GROUPED {
    ...
    path hq_list          // All HQ genomes list
    tuple val(group_name), val(genome_ids)  // (group_name, [genome_id1, genome_id2, ...])
...
PY
    ...
    # [4] (optional) also filter archaeal MSA if present, for completeness
